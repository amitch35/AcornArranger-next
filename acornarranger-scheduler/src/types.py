...
class SolverOptions(BaseModel):
    ...
    # minutes so the trade-off vs travel time is legible. Negative weights are
    # allowed and invert the signal (penalize high-affinity routing).
    ...
    # biases composition without dominating travel-time routing. Negative
    # weights prefer pairs with weaker historical chemistry (fresher teams).
