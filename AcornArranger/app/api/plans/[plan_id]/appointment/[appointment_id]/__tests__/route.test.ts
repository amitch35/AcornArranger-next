...
const validContext = { params: Promise.resolve({ plan_id: "10", appointment_id: "101" }) };
...
describe("POST /api/plans/[plan_id]/appointment/[appointment_id]", () => {
  ...
  it("returns 400 when plan_id is missing", async () => {
    ...
    const res = await POST(req, { params: Promise.resolve({ plan_id: "", appointment_id: "101" }) });
  ...
  it("returns 400 when appointment_id is missing", async () => {
    ...
    const res = await POST(req, { params: Promise.resolve({ plan_id: "10", appointment_id: "" }) });
  ...
  it("returns 400 for non-integer plan_id", async () => {
    ...
    const res = await POST(req, { params: Promise.resolve({ plan_id: "abc", appointment_id: "101" }) });
...
describe("DELETE /api/plans/[plan_id]/appointment/[appointment_id]", () => {
  ...
  it("returns 400 when plan_id is missing", async () => {
    ...
    const res = await DELETE(req, { params: Promise.resolve({ plan_id: "", appointment_id: "101" }) });
  ...
  it("returns 400 for non-integer appointment_id", async () => {
    ...
    const res = await DELETE(req, { params: Promise.resolve({ plan_id: "10", appointment_id: "xyz" }) });
