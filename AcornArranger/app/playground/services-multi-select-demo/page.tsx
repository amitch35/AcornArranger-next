...
import ServicesMultiSelect from "@/components/filters/ServicesMultiSelect";
import { useServiceOptions } from "@/lib/options/useServiceOptions";
...
export default function Page() {
  ...
  return (
    <div className="container mx-auto max-w-2xl space-y-4 p-6">
      <h1 className="text-xl font-semibold">ServicesMultiSelect Demo</h1>
      <p className="text-sm text-muted-foreground">Options loaded from /api/options/services via useServiceOptions().</p>
