...
- v0.25: **Task 15.1**; added `components/filters/DurationPicker` (HH:MM → minutes) with keyboard support, clamping (0–1440), and Vitest/RTL + `jest-axe` tests to support upcoming Properties settings editing.
